...
import { CalendarDays, Dumbbell, House, LineChart, Trophy, User } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <nav className="bg-background/80 supports-[backdrop-filter]:bg-background/60 fixed inset-x-0 bottom-0 z-40 border-t backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-md items-stretch justify-around px-1 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
