# Movra — FASE 1 · Arquitetura, Estrutura de Pastas e Design System
...
O Movra é um **PWA comercial** (Play Store / App Store via wrapper PWA), então a arquitetura precisa ser:
